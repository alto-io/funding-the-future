...
local function initialize(context)
    ...
    local free_gem_metadata =
    {
        type = "new_account_bonus"
    }

    w.update_wallet(context.user_id, 500, free_gem_metadata)
    ...
    nk.account_update_id(context.user_id, metadata, username, display_name, timezone, location, language, avatar_url)
